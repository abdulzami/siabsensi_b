...
const fetchMahasiswas = () => {
    axios.get('https://siabsensi.herokuapp.com/api/mahasiswa', {
        headers: {
            Authorization: 'Bearer ' + auth
        }
    })
...
const fetchMatkuls = () => {
    axios.get('https://siabsensi.herokuapp.com/api/matkul', {
        headers: {
            Authorization: 'Bearer ' + auth
        }
    })
...
const create_krs = async (user) => {
    await axios.post('https://siabsensi.herokuapp.com/api/krs', user, config_login)
        .then(response => {
